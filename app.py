...
# Template sayfaları için route'lar ekle
@app.route('/<page_name>.html')
def serve_page(page_name):
    # index.html kök dizinde, diğer HTML dosyaları templates klasöründe
    if page_name == 'index':
        return send_from_directory('.', 'index.html')
    return render_template(f'{page_name}.html')

if __name__ == '__main__':
    # Railway için port ayarını çevre değişkeninden al
